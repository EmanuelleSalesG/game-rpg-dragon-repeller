...
const locations = [
    ...
    {
        name: "store",
        "button text": ["Buy 10 health (10 gold)", "Buy weapon health (30 gold)", "Go to town square"],
    ...
    },
    {
        ...
        text: 'The monster screams "Arg!"j As it dies. You gain experience points and find gold.'
    },
    {
        name: "lose",
...
function buyHealth(){
    if(gold >= 10){
        ...
        text.innnerText = "You do not have enough gold to buy health.";
    }
...
function attack(){
    text.innnerText = "The " + monsters[fighting].name + " attacks.";
    ...
    healthText.innerText = health;
    monterHealth.innerText = monterHealth;
